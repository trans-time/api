...
defmodule Api.Moderation.Flag do
  ...
  def changeset(%Flag{} = user, attrs) do
    user
    |> cast(attrs, [:text, :bot, :illicit_activity, :trolling, :unconsenting_image, :comment_id, :timeline_item_id, :user_id, :moderation_report_id])
    |> validate_required([:bot, :illicit_activity, :trolling, :unconsenting_image])
