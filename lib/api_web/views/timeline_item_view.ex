defmodule ApiWeb.TimelineItemView do
  ...
  attributes [:date, :deleted, :private, :nsfw, :nsfw_butt, :nsfw_genitals, :nsfw_nipples, :nsfw_underwear, :text, :comments_are_locked, :comment_count, :moon_count, :star_count, :sun_count]
